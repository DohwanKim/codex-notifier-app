...
- 이벤트별로 macOS 알림, Telegram, Teams 라우팅을 켜고 끌 수 있습니다.
...
설정 화면에서 이벤트별 macOS / Telegram / Teams 채널을 각각 조정할 수 있습니다.
같은 화면에서 채널별 메시지 구성도 조정할 수 있으며, 전체 메시지/폴더명/브랜치 포함 옵션은 기본값이 모두 꺼져 있습니다.
